  ...
  return (
    <div className='flex flex-col w-full '>
      ...
      <div className='w-[704px] mx-auto pb-[100px]'>
        ...
        <h1 className='flex justify-center font-bold text-xl text-lightBlack'>Or</h1>
        <Link to='/edit-profile' className='font-Roboto font-semibold text-[14px] leading-[16.41px] text-[#0070D7]'>
          <button
            className='w-full mt-4 py-[15px] border-[1px] border-[#BEBEBE] rounded-md text-[#0070D7] font-Roboto font-semibold text-[14px] leading-[16.41px]'
            type="button"
            onClick={() => { /* Add functionality for creating resume */ }}>
